...
const RefreshIcon = props => (
  <IconContainer {...props}>
    <svg
      ...
      viewBox="0 0 496.156 496.156" space="preserve"
    >
      <path
        style={{ fill: '#32BEA6' }} d="M0,248.08C0,111.06,111.069,0.002,248.074,0.002c137.013,0,248.082,111.059,248.082,248.078c0,137.005-111.069,248.074-248.082,248.074C111.069,496.154,0,385.085,0,248.08z"
      />
      <g>
